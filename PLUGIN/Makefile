...
SOURCES = \
	__init__.py \
	cdu_creator.py cdu_creator_dialog.py

PLUGINNAME = cdu_creator

PY_FILES = \
	__init__.py \
	cdu_creator.py cdu_creator_dialog.py

UI_FILES = cdu_creator_dialog_base.ui
...
QGISDIR=C:\Users\roberta\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
